---
name: push-agent
description: Run the /push route as an in-session chain subagent.
---

Invoke the `/push` skill immediately and follow its procedure for the assigned route.
...
event and is therefore the chain carrier for `/push`.
