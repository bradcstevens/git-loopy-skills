...
```bash
npx skills add bradcstevens/git-loopy-skills --skill=prototype
```
...
[Source](https://github.com/bradcstevens/git-loopy-skills/tree/main/skills/prototype)
