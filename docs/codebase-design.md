...
```bash
npx skills add bradcstevens/git-loopy-skills --skill=codebase-design
```
...
[Source](https://github.com/bradcstevens/git-loopy-skills/tree/main/skills/codebase-design)
