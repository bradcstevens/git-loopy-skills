...
```bash
npx skills add bradcstevens/git-loopy-skills --skill=resolving-merge-conflicts
```
...
[Source](https://github.com/bradcstevens/git-loopy-skills/tree/main/skills/resolving-merge-conflicts)
