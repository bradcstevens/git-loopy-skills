...
```bash
npx skills add bradcstevens/git-loopy-skills --skill=code-review
```
...
[Source](https://github.com/bradcstevens/git-loopy-skills/tree/main/skills/code-review)
