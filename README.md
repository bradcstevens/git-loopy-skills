...
| [loose-ends](docs/loose-ends.md) | `/loose-ends` | Audit the issue tracker for workflow artifacts that were started but never followed up, then open a read-only HTML report of the findings. |
